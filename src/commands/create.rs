...
mod tests {
    ...
    fn create_test_metadata(name: Option<String>) -> SystemIdentityCreationMetadata {
    ...
    fn test_create_l1_system_identity_success() {
        let metadata = create_test_metadata(Some("l1_identity_test".to_string()));
    ...
    fn test_create_l2_system_identity_success() {
        ...
        let metadata = create_test_metadata(Some("l2_identity_test".to_string()));
